package com.nhnacademy.springexam;
...
import com.nhnacademy.springexam.resolver.DepartmentParserResolver;
...
class DepartmentParserServiceTest {
    ...
    void parsing(String filePath, int size) throws IOException, ParseException {
